...
@Composable
fun MostPlayedScreen(navController: NavHostController,
                     currentSong : String){
    Scaffold {paddingValues ->
        midSectionMostPlayed(paddingValues = paddingValues,navController,currentSong)
    }
}

@Composable
fun midSectionMostPlayed(paddingValues: PaddingValues,navController: NavHostController,
                         currentSong : String){
